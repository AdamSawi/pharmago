...
import { IconArrowRight, IconBag, IconFingerprint } from '@/components/icons';
...
function RolePill({ styles }: { styles: ReturnType<typeof createStyles> }) {
  ...
  return (
    <View style={styles.pill}>
      ...
      <Text style={styles.pillText}>Espace client</Text>
    </View>
  );
}
      ...
      >
        ...
        <View style={styles.titleBlock}>
          <Text style={styles.title}>
            {'Bon retour,\n'}
            <Text style={styles.titleItalic}>vos médicaments</Text>
            {'\nen un clic'}
          </Text>
          <Text style={styles.subtitle}>
            Connectez-vous pour commander vos médicaments et suivre vos livraisons.
          </Text>
        </View>
        ...
        <Pressable
          onPress={() => router.push('/(client)/register' as never)}
          style={styles.registerLink}
        >
          <Text style={styles.registerLinkText}>
            Pas encore de compte ?{' '}
            <Text style={styles.registerLinkAccent}>S'inscrire</Text>
          </Text>
        </Pressable>
